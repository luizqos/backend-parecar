...
const templatecancelaReserva = (dados) => {
    const corpoEmail =
        dados.canceladoPor === 'C'
            ? `<html>
                ...
                <tbody>
                    <tr>
                        <td class="header">
                            <div>
                                <p>
                                    <span class="greeting">Prezado(a), ${dados.localReserva}</span>
                                </p>
                                <p>
                                    <span class="message">Gostaríamos de informar que a reserva foi cancelada para
                                        o <strong>${dados.nome}</strong> agendado para <strong>${dados.dataReserva}</strong>.
                                    </span>
                                </p>
                                <p>
                            ...
                            <tr>    
                                ...
                                <td class="reserva-coluna2">${dados.nome}</td>
                            </tr>
                            <tr>
                                <td class="reserva-coluna1"><strong>Nº Reserva</strong></td>
                                <td class="reserva-coluna2">${dados.numeroReserva}</td>
                            </tr>
                            <tr>
                                <td class="reserva-coluna1"><strong>Data da Reserva</strong></td>
                                <td class="reserva-coluna2">${dados.dataReserva}</td>
                            </tr>
                            <tr>
                                <td class="reserva-coluna1"><strong>Local</strong></td>
                                <td class="reserva-coluna2">${dados.localReserva}</td>
                            </tr>
                        </table>
                    ...
                    <tbody>
                        <tr>
                            <td class="header">
                                <div>
                                    <p>
                                        <span class="greeting">Prezado(a), ${dados.nome}</span>
                                    </p>
                                    <p>
                                        <span class="message">Gostaríamos de informar que sua reserva foi cancelada para
                                            o <strong>${dados.localReserva}</strong> agendado para <strong>${dados.dataReserva}
                                                </strong>.
                                        </span>
                                    </p>
                                    <p>
